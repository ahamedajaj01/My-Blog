...
export default function Home() {
  return (
    <div className="bg-white text-gray-800">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-purple-600 to-pink-500 text-white py-20 px-4 text-center">
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-xl transition">
            ...
            />
            <div className="p-4">
              <h3 className="text-xl font-bold mb-2">Grow Professionally</h3>
              <p className="text-sm text-gray-600">
